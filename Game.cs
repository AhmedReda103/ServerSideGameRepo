...
namespace Server_Multi_Client_Project
{
    internal class Game
    {
        ...
        private static  void checkFileExistence()
        {
            ...
            string filePath = "C:\\Users\\Ahmed Reda\\Desktop\\Server_Multi_Client_Project\\bin\\Debug\\net8.0-windows\\Words.txt";
        ...
        public void receivedCharHandler(string receivedChar , int playerId , string playerName)
        {
            ...
            Debug.WriteLine("iam the clicked button from the client in server "  +receivedChar);
        ...
        {
            //back to check why 4 dialog appear 
